...
training_data, validation_data, test_data = data_loader.load_data_wrapper(trainingsData)

sizes=[780, 250, 150, 50, 1] #neurons in [input  ,hidden,  output] layer
#sizes=List()
#for i in layer_sizes: sizes.append(i)
...
net.SGD(training_data, max_epochs, n_epochs, num_eta_reductions, mini_batch_size, eta, lmbda = Lmbda,
        regularization = Reg,
        cost = Cost,
