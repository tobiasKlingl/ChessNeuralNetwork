...
if   version=="cupy" :
    import NNlib_1_8_cupy as nn
    import data_loader_cupy as data_loader
elif version=="numba":
    import NNlib_1_8_numba as nn
...
mBatchSize = 50      # Size of mini batches
...
if   version=="cupy":
    sizes =[780  ,500,500,1882]
elif version=="numba":
    sizes =nb.typed.List((780,500,250,50,1882))
